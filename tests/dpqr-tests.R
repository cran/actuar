...
## Distributions in the category are quite different, so let's treat
## them separately.
...
(Rinvtrgamma    <- rinvgamma    (n, shape  = 2,             scale = 5))
(Rinvweibull    <- rinvweibull  (n,             shape  = 3, scale = 5))
(Rinvexp        <- rinvexp      (n,                         scale = 5))
(Rlgamma <- rlgamma(n, shapelog = 2, ratelog = 0.2))
...
(Pinvtrgamma    <- pinvgamma    (Rinvtrgamma,   shape  = 2,             scale = 5))
(Pinvweibull    <- pinvweibull  (Rinvweibull,               shape  = 3, scale = 5))
(Pinvexp        <- pinvexp      (Rinvexp,                               scale = 5))
(Plgamma <- plgamma(Rlgamma, shapelog = 2, ratelog = 0.2))
...
## Just compute pdf
dfpareto(Rfpareto, min = m, shape1 = 0.8, shape2 = 1.5, shape3 = 2, scale = 2)
dpareto4(Rpareto4, min = m, shape1 = 0.8, shape2 = 1.5,             scale = 2)
dpareto3(Rpareto3, min = m,               shape  = 1.5,             scale = 2)
dpareto2(Rpareto2, min = m, shape  = 0.8,                           scale = 2)
dtrbeta      (Rtrbeta,       shape1 = 0.8, shape2 = 1.5, shape3 = 2, scale = 2)
dburr        (Rburr,         shape1 = 0.8, shape2 = 1.5,             scale = 2)
dllogis      (Rllogis,       shape  = 1.5, scale = 2)
dparalogis   (Rparalogis,    shape  = 0.8, scale = 2)
dgenpareto   (Rgenpareto,    shape1 = 0.8, shape2 = 2, scale = 2)
dpareto      (Rpareto,       shape  = 0.8, scale = 2)
dpareto1     (Rpareto1,      shape  = 0.8, min = 2)
dinvburr     (Rinvburr,      shape1 = 1.5, shape2 = 2, scale = 2)
dinvpareto   (Rinvpareto,    shape  = 2,   scale = 2)
dinvparalogis(Rinvparalogis, shape  = 2,   scale = 2)
dtrgamma     (Rtrgamma,      shape1 = 2, shape2 = 3, scale = 5)
dinvtrgamma  (Rinvtrgamma,   shape1 = 2, shape2 = 3, scale = 5)
dinvgamma    (Rinvtrgamma,   shape  = 2,             scale = 5)
dinvweibull  (Rinvweibull,               shape  = 3, scale = 5)
dinvexp      (Rinvexp,                               scale = 5)
dlgamma(Rlgamma, shapelog = 2, ratelog = 0.2)
dgumbel(Rgumbel, alpha = 2, scale = 5)
dinvgauss(Rinvgauss, mean = 2, dispersion = 5)
dgenbeta(Rgenbeta, shape1 = 0.8, shape2 = 1.5, shape3 = 2, scale = 2)
...
stopifnot({
    ...
    All.eq(Rinvtrgamma,   qinvgamma    (Pinvtrgamma,   shape  = 2,             scale = 5))
    All.eq(Rinvweibull,   qinvweibull  (Pinvweibull,               shape  = 3, scale = 5))
    All.eq(Rinvexp,       qinvexp      (Pinvexp,                               scale = 5))
    All.eq(Rlgamma, qlgamma(Plgamma, shapelog = 2, ratelog = 0.2))
...
stopifnot({
    ...
    All.eq(Rinvtrgamma,   qinvgamma    (1 - Pinvtrgamma,   shape  = 2,             scale = 5, lower = FALSE))
    ...
    All.eq(Rlgamma, qlgamma(1 - Plgamma, shapelog = 2, ratelog = 0.2, lower = FALSE))
...
stopifnot({
    ...
    All.eq(Rinvtrgamma,   qinvgamma    (log(Pinvtrgamma),   shape  = 2,             scale = 5, log = TRUE))
    ...
    All.eq(Rlgamma, qlgamma(log(Plgamma), shapelog = 2, ratelog = 0.2, log = TRUE))
...
stopifnot({
    ...
    All.eq(Rinvtrgamma,   qinvgamma    (log1p(-Pinvtrgamma),   shape  = 2,             scale = 5, lower = FALSE, log = TRUE))
    ...
    All.eq(Rlgamma, qlgamma(log1p(-Plgamma), shapelog = 2, ratelog = 0.2, lower = FALSE, log = TRUE))
...
## Just compute pmf
dztpois     (Rztpois,      lambda = 12)
dztnbinom   (Rztnbinom,    size = 7, prob = 0.01)
dztgeom     (Rztgeom,      prob = pi/16)
dztbinom    (Rztbinom,     size = 55, prob = pi/16)
dlogarithmic(Rlogarithmic, prob = pi/16)
dzmpois       (Rzmpoisp0lt,        lambda = 6, p0 = 0.001)
dzmpois       (Rzmpoisp0gt,        lambda = 6, p0 = 0.010)
dzmnbinom     (Rzmnbinomp0lt,      size = 7, prob = 0.8, p0 = 0.01)
dzmnbinom     (Rzmnbinomp0gt,      size = 7, prob = 0.8, p0 = 0.40)
dzmgeom       (Rzmgeomp0lt,        prob = pi/16, p0 = 0.01)
dzmgeom       (Rzmgeomp0gt,        prob = pi/16, p0 = 0.40)
dzmbinom      (Rzmbinomp0lt,       size = 12, prob = pi/16, p0 = 0.01)
dzmbinom      (Rzmbinomp0gt,       size = 12, prob = pi/16, p0 = 0.12)
dzmlogarithmic(Rzmlogarithmicp0lt, prob = 0.99, p0 = 0.05)
dzmlogarithmic(Rzmlogarithmicp0gt, prob = 0.99, p0 = 0.55)
dpoisinvgauss(Rpoisinvgauss,    mean = 12,  dispersion = 0.1)
dpoisinvgauss(RpoisinvgaussInf, mean = Inf, dispersion = 1.1)

## Check q<dist>(p<dist>(.)) identity
stopifnot({
    All.eq(Rztpois,      qztpois     (Pztpois,      lambda = 12))
    All.eq(Rztnbinom,    qztnbinom   (Pztnbinom,    size = 7, prob = 0.01))
    All.eq(Rztgeom,      qztgeom     (Pztgeom,      prob = pi/16))
    All.eq(Rztbinom,     qztbinom    (Pztbinom,     size = 55, prob = pi/16))
    All.eq(Rlogarithmic, qlogarithmic(Plogarithmic, prob = 0.99))
    All.eq(Rzmpoisp0lt,        qzmpois       (Pzmpoisp0lt,        lambda = 6, p0 = 0.001))
    All.eq(Rzmpoisp0gt,        qzmpois       (Pzmpoisp0gt,        lambda = 6, p0 = 0.010))
    All.eq(Rzmnbinomp0lt,      qzmnbinom     (Pzmnbinomp0lt,      size = 7, prob = 0.8, p0 = 0.01))
    All.eq(Rzmnbinomp0gt,      qzmnbinom     (Pzmnbinomp0gt,      size = 7, prob = 0.8, p0 = 0.40))
    All.eq(Rzmgeomp0lt,        qzmgeom       (Pzmgeomp0lt,        prob = pi/16, p0 = 0.01))
    All.eq(Rzmgeomp0gt,        qzmgeom       (Pzmgeomp0gt,        prob = pi/16, p0 = 0.40))
    All.eq(Rzmbinomp0lt,       qzmbinom      (Pzmbinomp0lt,       size = 12, prob = pi/16, p0 = 0.01))
    All.eq(Rzmbinomp0gt,       qzmbinom      (Pzmbinomp0gt,       size = 12, prob = pi/16, p0 = 0.12))
    All.eq(Rzmlogarithmicp0lt, qzmlogarithmic(Pzmlogarithmicp0lt, prob = 0.99, p0 = 0.05))
    All.eq(Rzmlogarithmicp0gt, qzmlogarithmic(Pzmlogarithmicp0gt, prob = 0.99, p0 = 0.55))
    All.eq(Rpoisinvgauss,    qpoisinvgauss(Ppoisinvgauss,    mean = 12,  dispersion = 0.1))
    All.eq(RpoisinvgaussInf, qpoisinvgauss(PpoisinvgaussInf, mean = Inf, dispersion = 1.1))
})

## Check q<dist>(p<dist>(.)) identity with upper tail
stopifnot({
    All.eq(Rztpois,      qztpois     (1 - Pztpois,      lambda = 12, lower = FALSE))
    All.eq(Rztnbinom,    qztnbinom   (1 - Pztnbinom,    size = 7, prob = 0.01, lower = FALSE))
    All.eq(Rztgeom,      qztgeom     (1 - Pztgeom,      prob = pi/16, lower = FALSE))
    All.eq(Rztbinom,     qztbinom    (1 - Pztbinom,     size = 55, prob = pi/16, lower = FALSE))
    All.eq(Rlogarithmic, qlogarithmic(1 - Plogarithmic, prob = 0.99, lower = FALSE))
    All.eq(Rzmpoisp0lt,        qzmpois       (1 - Pzmpoisp0lt,        lambda = 6, p0 = 0.001, lower = FALSE))
    All.eq(Rzmpoisp0gt,        qzmpois       (1 - Pzmpoisp0gt,        lambda = 6, p0 = 0.010, lower = FALSE))
    All.eq(Rzmnbinomp0lt,      qzmnbinom     (1 - Pzmnbinomp0lt,      size = 7, prob = 0.8, p0 = 0.01, lower = FALSE))
    All.eq(Rzmnbinomp0gt,      qzmnbinom     (1 - Pzmnbinomp0gt,      size = 7, prob = 0.8, p0 = 0.40, lower = FALSE))
    All.eq(Rzmgeomp0lt,        qzmgeom       (1 - Pzmgeomp0lt,        prob = pi/16, p0 = 0.01, lower = FALSE))
    All.eq(Rzmgeomp0gt,        qzmgeom       (1 - Pzmgeomp0gt,        prob = pi/16, p0 = 0.40, lower = FALSE))
    All.eq(Rzmbinomp0lt,       qzmbinom      (1 - Pzmbinomp0lt,       size = 12, prob = pi/16, p0 = 0.01, lower = FALSE))
    All.eq(Rzmbinomp0gt,       qzmbinom      (1 - Pzmbinomp0gt,       size = 12, prob = pi/16, p0 = 0.12, lower = FALSE))
    All.eq(Rzmlogarithmicp0lt, qzmlogarithmic(1 - Pzmlogarithmicp0lt, prob = 0.99, p0 = 0.05, lower = FALSE))
    All.eq(Rzmlogarithmicp0gt, qzmlogarithmic(1 - Pzmlogarithmicp0gt, prob = 0.99, p0 = 0.55, lower = FALSE))
    All.eq(Rpoisinvgauss,    qpoisinvgauss(1 - Ppoisinvgauss,    mean = 12,  dispersion = 0.1, lower = FALSE))
    All.eq(RpoisinvgaussInf, qpoisinvgauss(1 - PpoisinvgaussInf, mean = Inf, dispersion = 1.1, lower = FALSE))
})

## Check q<dist>(p<dist>(., log), log) identity
stopifnot({
    All.eq(Rztpois,      qztpois     (log(Pztpois),      lambda = 12, log = TRUE))
    All.eq(Rztnbinom,    qztnbinom   (log(Pztnbinom),    size = 7, prob = 0.01, log = TRUE))
    All.eq(Rztgeom,      qztgeom     (log(Pztgeom),      prob = pi/16, log = TRUE))
    All.eq(Rztbinom,     qztbinom    (log(Pztbinom),     size = 55, prob = pi/16, log = TRUE))
    All.eq(Rlogarithmic, qlogarithmic(log(Plogarithmic), prob = 0.99, log = TRUE))
    All.eq(Rzmpoisp0lt,        qzmpois       (log(Pzmpoisp0lt),        lambda = 6, p0 = 0.001, log = TRUE))
    All.eq(Rzmpoisp0gt,        qzmpois       (log(Pzmpoisp0gt),        lambda = 6, p0 = 0.010, log = TRUE))
    All.eq(Rzmnbinomp0lt,      qzmnbinom     (log(Pzmnbinomp0lt),      size = 7, prob = 0.8, p0 = 0.01, log = TRUE))
    All.eq(Rzmnbinomp0gt,      qzmnbinom     (log(Pzmnbinomp0gt),      size = 7, prob = 0.8, p0 = 0.40, log = TRUE))
    All.eq(Rzmgeomp0lt,        qzmgeom       (log(Pzmgeomp0lt),        prob = pi/16, p0 = 0.01, log = TRUE))
    All.eq(Rzmgeomp0gt,        qzmgeom       (log(Pzmgeomp0gt),        prob = pi/16, p0 = 0.40, log = TRUE))
    All.eq(Rzmbinomp0lt,       qzmbinom      (log(Pzmbinomp0lt),       size = 12, prob = pi/16, p0 = 0.01, log = TRUE))
    All.eq(Rzmbinomp0gt,       qzmbinom      (log(Pzmbinomp0gt),       size = 12, prob = pi/16, p0 = 0.12, log = TRUE))
    All.eq(Rzmlogarithmicp0lt, qzmlogarithmic(log(Pzmlogarithmicp0lt), prob = 0.99, p0 = 0.05, log = TRUE))
    All.eq(Rzmlogarithmicp0gt, qzmlogarithmic(log(Pzmlogarithmicp0gt), prob = 0.99, p0 = 0.55, log = TRUE))
    All.eq(Rpoisinvgauss,    qpoisinvgauss(log(Ppoisinvgauss),    mean = 12,  dispersion = 0.1, log = TRUE))
    All.eq(RpoisinvgaussInf, qpoisinvgauss(log(PpoisinvgaussInf), mean = Inf, dispersion = 1.1, log = TRUE))
})

## Check q<dist>(p<dist>(., log), log) identity with upper tail
stopifnot({
    All.eq(Rztpois,      qztpois     (log1p(-Pztpois),      lambda = 12, lower = FALSE, log = TRUE))
    All.eq(Rztnbinom,    qztnbinom   (log1p(-Pztnbinom),    size = 7, prob = 0.01, lower = FALSE, log = TRUE))
    All.eq(Rztgeom,      qztgeom     (log1p(-Pztgeom),      prob = pi/16, lower = FALSE, log = TRUE))
    All.eq(Rztbinom,     qztbinom    (log1p(-Pztbinom),     size = 55, prob = pi/16, lower = FALSE, log = TRUE))
    All.eq(Rlogarithmic, qlogarithmic(log1p(-Plogarithmic), prob = 0.99, lower = FALSE, log = TRUE))
    All.eq(Rzmpoisp0lt,        qzmpois       (log1p(-Pzmpoisp0lt),        lambda = 6, p0 = 0.001, lower = FALSE, log = TRUE))
    All.eq(Rzmpoisp0gt,        qzmpois       (log1p(-Pzmpoisp0gt),        lambda = 6, p0 = 0.010, lower = FALSE, log = TRUE))
    All.eq(Rzmnbinomp0lt,      qzmnbinom     (log1p(-Pzmnbinomp0lt),      size = 7, prob = 0.8, p0 = 0.01, lower = FALSE, log = TRUE))
    All.eq(Rzmnbinomp0gt,      qzmnbinom     (log1p(-Pzmnbinomp0gt),      size = 7, prob = 0.8, p0 = 0.40, lower = FALSE, log = TRUE))
    All.eq(Rzmgeomp0lt,        qzmgeom       (log1p(-Pzmgeomp0lt),        prob = pi/16, p0 = 0.01, lower = FALSE, log = TRUE))
    All.eq(Rzmgeomp0gt,        qzmgeom       (log1p(-Pzmgeomp0gt),        prob = pi/16, p0 = 0.40, lower = FALSE, log = TRUE))
    All.eq(Rzmbinomp0lt,       qzmbinom      (log1p(-Pzmbinomp0lt),       size = 12, prob = pi/16, p0 = 0.01, lower = FALSE, log = TRUE))
    All.eq(Rzmbinomp0gt,       qzmbinom      (log1p(-Pzmbinomp0gt),       size = 12, prob = pi/16, p0 = 0.12, lower = FALSE, log = TRUE))
    All.eq(Rzmlogarithmicp0lt, qzmlogarithmic(log1p(-Pzmlogarithmicp0lt), prob = 0.99, p0 = 0.05, lower = FALSE, log = TRUE))
    All.eq(Rzmlogarithmicp0gt, qzmlogarithmic(log1p(-Pzmlogarithmicp0gt), prob = 0.99, p0 = 0.55, lower = FALSE, log = TRUE))
    All.eq(Rpoisinvgauss,    qpoisinvgauss(log1p(-Ppoisinvgauss),    mean = 12,  dispersion = 0.1, lower = FALSE, log = TRUE))
    All.eq(RpoisinvgaussInf, qpoisinvgauss(log1p(-PpoisinvgaussInf), mean = Inf, dispersion = 1.1, lower = FALSE, log = TRUE))
})
