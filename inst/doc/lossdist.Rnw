...
model on the unobservable random variable $X$. This requires
expressing the pdf or cdf of $Y^L$ (or $Y^P$) in terms of the pdf or
cdf of $X$. Function \code{coverage} of \pkg{actuar} does just that:
given a pdf or cdf and any combination of the coverage modifications
