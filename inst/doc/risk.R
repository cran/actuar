...
###################################################
### code chunk number 1: risk.Rnw:81-83
###################################################
library(actuar)
...
###################################################
### code chunk number 2: risk.Rnw:223-249
###################################################
...
###################################################
### code chunk number 3: risk.Rnw:263-268 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 4: risk.Rnw:388-394
###################################################
fx <- discretize(pgamma(x, 2, 1), method = "unbiased",
...
###################################################
### code chunk number 5: risk.Rnw:398-402
###################################################
...
###################################################
### code chunk number 6: risk.Rnw:406-407
###################################################
knots(Fs)                      # support of Fs.b (knots)


###################################################
### code chunk number 7: risk.Rnw:411-412 (eval = FALSE)
###################################################
## plot(Fs, do.points = FALSE, verticals = TRUE, xlim = c(0, 60))


###################################################
### code chunk number 8: risk.Rnw:416-417
###################################################
plot(Fs, do.points = FALSE, verticals = TRUE, xlim = c(0, 60))


###################################################
### code chunk number 9: risk.Rnw:428-431
###################################################
...
###################################################
### code chunk number 10: risk.Rnw:436-437
###################################################
diff(Fs)


###################################################
### code chunk number 11: risk.Rnw:459-461
###################################################
VaR(Fs)
CTE(Fs)
...
###################################################
### code chunk number 12: risk.Rnw:469-495
###################################################
...
###################################################
### code chunk number 13: risk.Rnw:586-588
###################################################
...
###################################################
### code chunk number 14: risk.Rnw:618-624
###################################################
...
###################################################
### code chunk number 15: risk.Rnw:629-630
###################################################
plot(rho)


###################################################
### code chunk number 16: risk.Rnw:730-734
###################################################
...
###################################################
### code chunk number 17: risk.Rnw:739-740
###################################################
op <- options(width=50)


###################################################
### code chunk number 18: risk.Rnw:742-746
###################################################
ruin(claims = "e",
...
###################################################
### code chunk number 19: risk.Rnw:752-758
###################################################
...
###################################################
### code chunk number 20: risk.Rnw:764-770
###################################################
psi <- ruin(claims = "p",
            par.claims = list(prob = prob, rates = rates),
            wait = "e",
...
###################################################
### code chunk number 21: risk.Rnw:772-773
###################################################
options(op)


###################################################
### code chunk number 22: risk.Rnw:778-779
###################################################
plot(psi, from = 0, to = 50)


###################################################
### code chunk number 23: risk.Rnw:848-858
###################################################
...
###################################################
### code chunk number 24: risk.Rnw:864-870
###################################################
...
###################################################
### code chunk number 25: risk.Rnw:875-877
###################################################
curve(psi.L, from = 0, to = 100, col = "blue")
curve(psi.U, add = TRUE, col = "green")
