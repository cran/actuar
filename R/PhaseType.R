...
dphtype <- function (x, prob, rates, log = FALSE)
    .External("do_dpqphtype", "dphtype", x, prob, rates, log)

pphtype <- function (q, prob, rates, lower.tail = TRUE, log.p = FALSE)
    .External("do_dpqphtype", "pphtype", q, prob, rates, lower.tail, log.p)

rphtype <- function (n, prob, rates)
    .External("do_randomphtype", "rphtype", n, prob, rates)

mphtype <- function (order, prob, rates)
    .External("do_dpqphtype", "mphtype", order, prob, rates, FALSE)

mgfphtype <- function (x, prob, rates, log = FALSE)
    .External("do_dpqphtype", "mgfphtype", x, prob, rates, log)
